...
namespace Oculus.Interaction.Samples.PalmMenu
{
    ...
    /// </summary>
    public class MyPalmMenuBehavior : MonoBehaviour
    {
        [SerializeField]
        ...
        private bool _leftNavSelected = false;
        private bool _leftNavPrevSelected = false;
        ...
        private void Update()
        {
            ...
            if (_rightNavSelected) _rightNavSelected = false;
        }
        ...
        {
            _leftNavSelected = true;
        }
        public void SetMenuRight() 
        {
            _rightNavSelected = true;
        }
    }
}
